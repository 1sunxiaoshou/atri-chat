...
@router.get(
    "/characters/{character_id}/motions",
    summary="获取角色的所有动作绑定",
...
async def get_character_motions(
    ...
    try:
        ...
        bindings = (
            ...
            .filter(CharacterMotionBinding.character_id == character_id)
            .all()
        )
        ...
        raise HTTPException(status_code=500, detail="获取绑定失败") from e
...
async def update_character_motions(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="更新角色动作绑定失败") from e
...
async def delete_character_motions(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="删除角色动作绑定失败") from e
