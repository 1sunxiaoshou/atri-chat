...
async def transcribe_audio(
    ...
    language: LanguageType | None = Form(default="auto"),
    use_int8: str | None = Form(default="false"),  # 改为接收 str 以处理前端传参
    ...
    try:
        ...
        return ResponseModel(
            ...
            data={
                "text": text,
                "language": language,
                "precision": "INT8" if use_int8_bool else "FP32",
            },
        )
        ...
        raise HTTPException(status_code=500, detail="服务器内部推理错误") from e
