...
from core.db import Avatar, Character, Voice
...
@router.post(
    "/avatars", response_model=AvatarResponse, status_code=status.HTTP_201_CREATED
)
...
def list_characters(skip: int = 0, limit: int = 20, db: Session = Depends(get_db)):
    """列出所有角色
