...
def test_memory_system():
    ...
    # 使用测试角色 ID
    test_character_id = TEST_CHARACTER_ID
    ...
    result = memory_read.invoke(
        {"file": "user_profile", "section": "Basic Info", "runtime": runtime}
    )
    print(result)
    ...
    print("-" * 60)
    result = memory_read.invoke(
        {"file": "memory_stream", "tail_lines": 5, "runtime": runtime}
    )
    print(result)
    ...
    print("测试 7: 搜索记忆")
    print("-" * 60)
    result = memory_search.invoke({"query": "测试", "runtime": runtime})
    print(result)
    ...
    print("测试 9: 列出话题")
    print("-" * 60)
    result = memory_list.invoke({"file": "topics", "runtime": runtime})
    print(result)
...
if __name__ == "__main__":
    ...
    print("-" * 60)
    from core.middleware.load_memory import _has_meaningful_content
