...
const translations: Record<Language, Translations> = {
  en: {
    ...
    'sidebar.adminDashboard': 'Resource Configuration',
    ...
    'chat.code': 'Code',
    // Chat Settings (Right Sidebar)
    'chat.settings.title': 'Chat Settings',
    'chat.settings.modelSelection': 'Model Selection',
    'chat.settings.temperature': 'Temperature',
    'chat.settings.temperatureDesc': 'Control randomness and creativity',
    'chat.settings.precise': 'Precise',
    'chat.settings.creative': 'Creative',
    'chat.settings.enableThinking': 'Deep Thinking',
    'chat.settings.enableThinkingDesc': 'Enable deeper reasoning (supported models)',
    'chat.settings.reset': 'Reset to Defaults',
    // Admin - General
    'admin.title': 'Resource Configuration',
    ...
    'admin.rerank': 'Rerank',
    'admin.selectModel': 'Select Model',
    'admin.providerIdPlaceholder': 'e.g. OpenAI, Tongyi, Claude',
    'admin.providerIdHelp': 'Supports Chinese, Japanese, English, numbers and symbols',
    'admin.selectTemplate': 'Select Template',
    'admin.addModelTitle': 'Add Model',
    'admin.modelIdLabel': 'Model ID',
    'admin.modelIdPlaceholder': 'e.g. gpt-4, claude-3-opus',
    'admin.modelTypeLabel': 'Model Type',
    'admin.textModel': 'Text',
    'admin.embeddingModel': 'Embedding',
    'admin.rerankModel': 'Rerank',
    'admin.capabilitiesLabel': 'Capabilities',
    'admin.capabilitiesHelp': 'Click to select/deselect capabilities',
    'admin.enableModel': 'Enable this model',
    // Admin - Characters
  ...
  zh: {
    ...
    'chat.settings.modelSelection': '模型选择',
    'chat.settings.temperature': '温度',
    'chat.settings.temperatureDesc': '控制回复的随机性和创造性',
    'chat.settings.precise': '精确',
    'chat.settings.creative': '创造',
    'chat.settings.enableThinking': '深度思考',
    'chat.settings.enableThinkingDesc': '让模型进行更深入的推理（支持的模型）',
    'chat.settings.reset': '重置为默认值',
    // Admin - General
    'admin.title': '资源配置',
    'admin.providers': '供应商',
    'admin.models': '模型',
    ...
    'admin.embedding': '嵌入',
    'admin.rerank': '重排',
    'admin.selectModel': '选择模型',
    'admin.providerIdPlaceholder': '例如: OpenAI, 通义千问, Claude',
    'admin.providerIdHelp': '支持中日英文、数字和符号',
    'admin.selectTemplate': '选择模板类型',
    'admin.addModelTitle': '添加模型',
    'admin.modelIdLabel': '模型 ID',
    'admin.modelIdPlaceholder': '例如: gpt-4, claude-3-opus',
    'admin.modelTypeLabel': '模型类型',
    'admin.textModel': 'Text (文本)',
    'admin.embeddingModel': 'Embedding (嵌入)',
    'admin.rerankModel': 'Rerank (重排)',
    'admin.capabilitiesLabel': '能力标签',
    'admin.capabilitiesHelp': '点击选择/取消能力标签',
    'admin.enableModel': '启用此模型',
    // Admin - Characters
