...
const translations: Record<Language, Translations> = {
  en: {
    ...
    'sidebar.characterManagement': 'Character Management',
    ...
    'admin.toolUse': 'Tool Use',
    'admin.webSearch': 'Web Search',
    'admin.selectProvider': 'Select a Provider',
    'admin.selectProviderDesc': 'Choose a provider from the sidebar to manage its models, configurations, and settings.',
    'admin.noModelsFound': 'No models found',
    'admin.noModelsFoundDesc': 'Try adjusting filters or sync models from provider.',
  ...
  zh: {
    ...
    'sidebar.characterManagement': '角色管理',
    ...
    'admin.toolUse': '工具',
    'admin.webSearch': '搜索',
    'admin.selectProvider': '选择供应商',
    'admin.selectProviderDesc': '从侧边栏选择一个供应商来管理其模型、配置和设置。',
    'admin.noModelsFound': '未找到模型',
    'admin.noModelsFoundDesc': '尝试调整筛选条件或同步供应商模型。',
