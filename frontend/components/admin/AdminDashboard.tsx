    ...
    <div className="flex flex-col h-full bg-gray-50 dark:bg-gray-900/50 relative">
      ...
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 lg:px-8 pt-6">
        ...
        <button
          ...
          className="lg:hidden absolute top-4 left-4 p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg text-gray-600 dark:text-gray-400 transition-colors"
        ...
        <div className="flex gap-4 lg:gap-8 overflow-x-auto scrollbar-hide -mx-4 px-4 lg:mx-0 lg:px-0">
          {[
            ...
            <button
              ...
              className={`pb-4 px-2 flex items-center gap-2 font-medium transition-all relative whitespace-nowrap flex-shrink-0 ${activeTab === tab.id ? 'text-blue-600 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'
                }`}
            >
